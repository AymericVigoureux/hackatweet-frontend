...
function Home() {
  ...
  useEffect(() => {
    ...
    fetch(`https://hackatweet-backend-685952935346.europe-west9.run.app/tweets/all/${user.token}`)
  ...
  const handleSubmit = () => {
    fetch('https://hackatweet-backend-685952935346.europe-west9.run.app/tweets', {
      method: 'POST',
